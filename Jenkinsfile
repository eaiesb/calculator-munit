...
stage ("calculator-munit-mule4"){
  ...
  "files": [
    {
      "pattern": "**/*.jar",
      "target": "generic-local/Calculator-munit-mule4_$BUILD_NUMBER_qa/Calculator-munit-mule4.jar"
    }
 ]
}"""                 
          def buildInfo1 = server.upload spec: uploadSpec
  ...
  "files": [
    {
      "pattern": "**/*.jar",
      "target": "generic-local/Calculator-munit-mule4_$BUILD_NUMBER_prod/Calculator-munit-mule4.jar"
    }
 ]
}"""                 
          def buildInfo1 = server.upload spec: uploadSpec
